...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { caption: @update.caption, subject: @update.subject } }, as: :json
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { caption: @update.caption, subject: @update.subject } }, as: :json
    assert_response 200
  end
